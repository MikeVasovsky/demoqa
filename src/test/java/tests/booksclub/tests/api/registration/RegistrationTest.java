...
public class RegistrationTest extends BaseTest {
    ...
    void repeateUsernameAndEmptyPasswordTest() {
        RegistrationFullModel data = new RegistrationFullModel(t.randomUsername, t.randomPassword);
        api.reg.registration(data);

        RegistrationFullModel secondData = new RegistrationFullModel(t.randomUsername, "");
